#!/bin/bash
# filepath: run_r2egym_32b_agent.sh

# Exit on any error
set -e

echo "Starting SWE-Bench evaluation with SWE-smith-32B-Agent..."

# Configuration
MODEL_NAME="openai/SWE-smith-32B-Agent_qwen32B_bs1x8_lr5e-5_ep3"
...
MAX_STEPS=40
TEMPERATURE=0
API_ENDPOINT="http://localhost:8015"  # vLLM server endpoint
EXP_NAME="swe-smith-32b-agent-swebench-eval-$(date +%Y%m%d_%H%M%S)"
TRAJ_DIR="./traj"
